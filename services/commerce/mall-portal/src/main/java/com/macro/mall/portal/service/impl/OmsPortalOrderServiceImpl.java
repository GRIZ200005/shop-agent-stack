...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    public Map<String, Object> generateOrder(OrderParam orderParam) {
        ...
        UmsMemberReceiveAddress validatedAddress = memberReceiveAddressService.getItem(orderParam.getMemberReceiveAddressId());
        if (validatedAddress == null || !currentMember.getId().equals(validatedAddress.getMemberId())) {
            Asserts.fail("Shipping address not available");
        }
        if (CollectionUtils.isEmpty(cartPromotionItemList)) {
            Asserts.fail("At least one cart item is required");
        }
        ...
        //收货人信息：姓名、电话、邮编、地址
        UmsMemberReceiveAddress address = validatedAddress;
    ...
    public OmsOrderDetail detail(Long orderId) {
        ...
        UmsMember currentMember = memberService.getCurrentMember();
        if (omsOrder == null || !currentMember.getId().equals(omsOrder.getMemberId())) {
            Asserts.fail("Order not available");
        }
