...
/** Original Aster: customer ownership is resolved from the authenticated member. */
...
public class AsterSupportController {
 ...
 public AsterSupportController(SupportService s,UmsMemberService m){support=s;members=m;}
