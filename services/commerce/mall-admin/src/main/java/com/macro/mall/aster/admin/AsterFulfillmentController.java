...
/** Original Aster: live administrator checks for order fulfillment. */
@RestController @RequestMapping("/aster/fulfillment")
public class AsterFulfillmentController {
 private final FulfillmentService service;private final AsterStaffAccess access;
 public AsterFulfillmentController(FulfillmentService s,AsterStaffAccess a){service=s;access=a;}
